  ...
  \begin{tikzpicture}[overlay,remember picture]
    ...
    \begin{tikzpicture}[overlay,remember picture]
      ...
      \node[rectangle, anchor=north west,
              ...
              {\parbox[t]{0.35\textwidth}{\color{white} Find Camp 100 on the internet\\[-0.5em] \begin{itemize}[leftmargin=1.5em]
      ...
      \node[rectangle, anchor=north west,
              ...
              {\parbox[t]{0.25\textwidth}{\color{white} Find Woodcraft Folk Online\\[-0.5em] \begin{itemize}[leftmargin=1.5em]
                \setlength\itemsep{0.7em}
