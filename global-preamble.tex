...
\newcommand{\tablehead}[1]{\centering\arraybackslash \cellcolor{c100-red}\leavevmode\color{white}\textbf{#1}} % we try this as it actually allows automatic linebreaks in the headings
